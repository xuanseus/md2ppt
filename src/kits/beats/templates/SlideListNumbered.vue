...
.wrap { display:flex; flex-direction:column; align-items:center; width:fit-content; min-width:min(calc(44rem * var(--content-scale)),100%); max-width:min(calc(60rem * var(--content-scale)),calc(100% - 8rem),100%); }
