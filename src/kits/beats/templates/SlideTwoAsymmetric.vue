...
<template>
  <div class="root">
    <div class="wrap">
      ...
      <div class="grid" :style="{ gridTemplateColumns: `${ratio.l}fr ${ratio.r}fr` }">
...
.col { position:relative; overflow:hidden; padding:2rem; border-radius:1rem; }
.col-top { position:absolute; top:0; left:1.5rem; right:1.5rem; height:2px; border-radius:9999px; }
.col-title { font-size:var(--fs-h4); font-weight:700; margin-bottom:1rem; padding-bottom:0.5rem; border-bottom:2px solid color-mix(in srgb,var(--color-accent) 30%,transparent); }
