...
<template>
  <div class="holo-quote relative flex items-center justify-center w-full h-full overflow-hidden" style="background: var(--color-background)">
    <!-- ============ 传输信号波（从四周指向中心） ============ -->
    ...
    <div class="relative z-10 holo-message-bubble">
      ...
      <div class="holo-bubble-body">
        ...
        <div class="holo-bubble-cite">
          ...
          <span class="holo-cite-text">TRANSMISSION</span>
          <span class="holo-cite-diamond"></span>
        </div>

        <!-- 引用内容 -->
        <div v-html="slide.html" class="holo-quote-prose"></div>
...
.holo-quote-prose :deep(blockquote),
.holo-quote-prose :deep(p) {
...
.holo-quote-prose :deep(p::before) {
  content: '\300C ';
