...
<template>
  <div class="holo-section-number relative flex items-center justify-center w-full h-full overflow-hidden" style="background: var(--color-background)">
    <!-- ============ 背景辐射线 ============ -->
    ...
    <div class="relative z-10 flex items-center justify-center" style="min-width: 50vw; min-height: 50vh;">
      ...
      <div class="relative z-10 text-center px-8">
        <!-- 章节编号 -->
        <div class="holo-section-num">{{ num }}</div>
        <!-- 标题 -->
