...
<template>
  <!-- Pixel Retro two-column top-bottom — pixel-bordered columns stacked -->
  <div class="px-two-stack flex items-center justify-center w-full h-full" :style="{ background: 'var(--color-background)' }">
    <!-- CRT scanline -->
